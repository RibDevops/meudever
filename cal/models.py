...
class Event(models.Model):
    ...
    start_time = models.DateField(
        verbose_name="Data da conteúdo ministrado",
    ...
    def data_formatada_conteudo(self):
        if self.start_time is None:  # Verificação para evitar erro
            return "N/A"
        ...
        try:
            ...
            locale.setlocale(locale.LC_TIME, 'pt_BR')
        return self.start_time.strftime("%d %A")
